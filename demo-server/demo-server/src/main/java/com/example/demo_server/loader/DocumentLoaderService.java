//package com.example.demo_server.loader;
//
...
//
//                // Add metadata
//                if (file.getName().toLowerCase().contains("holidays")) {
//                    doc.metadata().put("category", "holidays");
//                } else if (file.getName().toLowerCase().contains("holidays")) {
//                    doc.metadata().put("category", "holidays");
//                }else {
